...
namespace WarehouseManagement.Controller
{
    public class UserController
    {
        ...
        public static int GetSenderID(string senderName)
        {
            sql.AddParam("@sendername", senderName);
            return int.Parse(sql.ReturnResult($"SELECT sender_id FROM tbl_sender WHERE sender_name = @sendername "));
        }
